...
class InjexContainer {
    ...
    loadProjectFiles() {
        ...
        this.config.rootDirs
            ...
            .map((dir) => (this.throwIfRootDirNotExists(dir), utils_1.getAllFilesInDir(dir, this.config.globPattern)))
    ...
    throwIfRootDirNotExists(dir) {
        if (!utils_1.isDirExists(dir)) {
            throw new errors_1.RootDirectoryNotExistError(dir);
        }
    }
    createModules() {
