...
Define a middleware or a list of chainable middlewares on a controller route handler. A middleware is a class that implements the [`IMiddleware`](https://www.injex.dev/docs/api/core/enums-interfaces#imiddleware) interface.
...
If you want a quick demo to play with, check out the [express example](https://www.injex.dev/docs/examples#express-plugin-example) in the examples section.